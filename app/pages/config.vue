    ...
    <div class="max-w-4xl grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            <form @submit.prevent="handleSave" class="glass-panel p-6 md:p-8 rounded-xl space-y-6">
                <!-- Interface Header -->
                <div class="bg-green-600/20 border border-green-500/30 p-3 rounded text-green-400 font-bold">
                    Interface
                </div>
                ...
                <div class="space-y-4">
                    <div class="space-y-1">
                        ...
                        <div class="flex gap-2">
                            ...
                            <button type="button" class="px-3 py-2 bg-green-600 hover:bg-green-500 text-white rounded text-sm font-bold flex items-center gap-1">
                ...
                <div class="pt-4 flex items-center justify-between">
                     <p v-if="successMsg" class="text-green-400 font-medium flex items-center gap-2">
                        <span class="material-symbols-outlined">check_circle</span>
                        {{ successMsg }}
                    </p>
                    <button type="submit" :disabled="loading" class="px-6 py-2.5 bg-green-600 hover:bg-green-500 text-white font-bold rounded-lg transition-colors flex items-center gap-2 disabled:opacity-50">
        ...
        <div class="space-y-6">
            ...
            <div class="glass-panel p-6 rounded-xl space-y-4">
                ...
                <div v-if="statusResult" class="p-3 rounded-lg border text-sm" :class="statusResult.success ? 'bg-green-500/10 border-green-500/30 text-green-400' : 'bg-red-500/10 border-red-500/30 text-red-400'">
            ...
            <div class="glass-panel p-6 rounded-xl space-y-4">
                ...
                <div class="pt-2 flex items-center justify-between">
                    <p v-if="smtpSuccessMsg" class="text-green-400 text-sm flex items-center gap-1">
