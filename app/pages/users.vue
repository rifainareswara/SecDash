...
<template>
  <div class="space-y-6 md:space-y-8">
    <div class="flex items-center justify-between">
            ...
            <button @click="showAddModal = true" class="flex items-center gap-2 px-4 py-2 bg-primary hover:bg-green-400 text-black rounded-lg text-sm font-bold transition-colors shadow-[0_0_15px_rgba(6,249,6,0.3)]">
        ...
        <div v-for="client in clients" :key="client.id" class="glass-panel p-4 rounded-xl flex flex-col justify-between">
            <div>
                <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="px-2 py-1 rounded text-xs font-bold" :class="client.enabled ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'">
    ...
    <div v-if="showAddModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
        <div class="glass-panel p-6 rounded-xl w-full max-w-md m-4">
            ...
            <div class="flex justify-end gap-3 mt-6">
                ...
                <button @click="handleAddClient" class="px-4 py-2 bg-primary text-black font-bold rounded-lg hover:bg-green-400">Create Client</button>
            </div>
        </div>
    </div>
